...
const Comments = () => {
    ...
    return (
        <div className='flex-1 pt-5 px-5 sm:pt-12 sm:pl-16 bg-blue-50/50'>
            ...
            <div className='relavite h-4/5 max-w-3xl overflow-x-auto mt-4 bg-white shadow rounded-lg scroll-hide'>
                <table className='w-full text-sm text-gray-500'>
                    ...
                    <tbody>
                        ...
                        }).map((comment, index) => <CommentTableItem key={comment._id} index={index + 1} comment={comment} fetchComments={fetchComments} />)}
                    </tbody>
                </table>
            </div>
        </div>
